...
import frame18 from "../../assets/images/frame-18.png";
...
import frame23 from "../../assets/images/frame-23.png";
            ...
            <header className="header">
              ...
              <div className="header_body">
                ...
                <div className="bodyImg">
                  <img src={frame13} alt="Burger Image" />
                </div>
              </div>
            </header>
          </div>
                ...
                <div className="item-card-contain">
                  ...
                  <div className="item-card-contain item-contain-mt-30 item-card-contain2">
                    <div className="hghlt-text-contain">
                      <img src={frame15} alt="Tomato Image" className="abs-img" />
          ...
          <div className="page-center">
            <div className="exclusive-deal-contain">
              <div className="section-head deal-sec-head">
                ...
                <div className="item-span-head">
                  <img src={frame18} alt="Deal Section Heading Image" className="left-img" />
                  Of the Week
                  <img src={frame18} alt="Deal Section Heading Image" className="right-img" />
                </div>
                <div className="line"></div>
              ...
              <div className="deal-cntnt-contain">
                ...
                <div className="deal-sec-img">
                  <img src={frame13} alt="Deal Section Image" />
                </div>
        ...
        <div className="text-moving-cntnt-grp top-cntnt-grp">
          <div className="text-moving-item">
            ...
            <div className="text-moving-img">
              <img src={logo} alt="Find Recipe Now logo" />
            </div>
            <div className="text-moving-txt">Recipe Now</div>
            <div className="text-moving-img">
              <img src={frame16} alt="Design Element" />
            </div>
          </div>
          <div className="text-moving-item">
            <div className="text-moving-txt">Find Your</div>
            <div className="text-moving-img">
              <img src={frame21} alt="Find Recipe Now logo" />
            </div>
            <div className="text-moving-txt">Recipe Now</div>
            <div className="text-moving-img">
              <img src={frame23} alt="Design Element" />
            </div>
          </div>
        </div>
        <div className="text-moving-cntnt-grp top-cntnt-grp">
          <div className="text-moving-item">
            ...
            <div className="text-moving-txt">Recipe Now</div>
            <div className="text-moving-img">
              <img src={frame24} alt="Design Element" />
            </div>
          </div>
          <div className="text-moving-item">
            <div className="text-moving-txt">Find Your</div>
            <div className="text-moving-img">
              <img src={frame22} alt="Find Recipe Now logo" />
            </div>
            <div className="text-moving-txt">Recipe Now</div>
            <div className="text-moving-img">
              <img src={frame13} alt="Design Element" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="text-moving-cntnt-container">
        <div className="text-moving-cntnt-grp middle-cntnt-grp">
          <div className="text-moving-item">
            ...
            <div className="text-moving-img">
              <img src={frame7} alt="Design Element" />
            </div>
          ...
          <div className="text-moving-item">
            <div className="text-moving-txt">Cook With</div>
            <div className="text-moving-img">
              <img src={frame15} alt="Design Element" />
            </div>
            <div className="text-moving-txt">Great Joy</div>
            <div className="text-moving-img">
        ...
        <div className="text-moving-cntnt-grp middle-cntnt-grp">
          <div className="text-moving-item">
            <div className="text-moving-txt">Cook With</div>
            <div className="text-moving-img">
              <img src={frame21} alt="Design Element" />
            </div>
            <div className="text-moving-txt">Great Joy</div>
            <div className="text-moving-img">
              <img src={frame23} alt="Design Element" />
          ...
          <div className="text-moving-item">
            <div className="text-moving-txt">Cook With</div>
            <div className="text-moving-img">
              <img src={frame18} alt="Design Element" />
            </div>
            <div className="text-moving-txt">Great Joy</div>
            <div className="text-moving-img">
              <img src={frame9} alt="Design Element" />
            </div>
          </div>
        </div>
        <div className="text-moving-cntnt-grp middle-cntnt-grp">
          ...
          <div className="text-moving-item">
            <div className="text-moving-txt">Cook With</div>
            <div className="text-moving-img">
              <img src={frame22} alt="Design Element" />
            </div>
            <div className="text-moving-txt">Great Joy</div>
            <div className="text-moving-img">
              <img src={frame15} alt="Design Element" />
