...
import { Link } from "react-router-dom";// Added useState and useEffect
    ...
    <form onSubmit={handleSubmit}>
      ...
      >
        <div className="container mx-auto mt-8 p-6 bg-white rounded">
          ...
          <Link to="/profile">
          <button
            className="bg-blue-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded ml-auto relative left-5"
            type="submit"
          >
            Go Back
          </button>
