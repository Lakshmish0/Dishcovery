...
export const Navbar = () => {
  ...
  return (
    <header style={{ backgroundColor: "#ffb300", height: "100px", borderRadius: "20px" }} className="p-5 shadow-md flex justify-between items-center">
      ...
      <div style={{right: "350px"}} className=" justify-start
      ...
      <div className="profile flex items-center">
        ...
        <span className="ml-4 name">
          <div>{firstName} {lastName}</div>
        </span>

        <button
          className="loginout ml-4 font-semibold relative px-4 border border-white rounded-2xl"
