...
export const BookmarkedRecipes = () => {
  ...
  const currentRecipes = bookmarkedRecipes.slice(indexOfFirstRecipe, indexOfLastRecipe);
    ...
    <div className="py-10 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex space-x-6 mb-6">
          ...
          <Link to="/bookmarked-recipes" className="hover:underline text-yellow-600">
            Bookmarked Recipes
          </Link>
        </div>
        ...
        <div className="flex justify-between items-center py-6">
          ...
          {/* Next Page Button */}
          {currentPage < Math.ceil(bookmarkedRecipes.length / recipesPerPage) && (
            <span 
              className="text-yellow-500 text-lg cursor-pointer"
              onClick={nextPage}
            >
